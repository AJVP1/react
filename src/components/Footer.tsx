...
export default function Footer() {
  ...
  // Si el indice actual no es el primero, mostramos enlace anterior, sino no mostramos nada
  const prev = currentIndex > 0 ? allItems[currentIndex - 1] : null;
  // Si el indice actual no es el ultimo, mostramos enlace siguiente, sino no mostramos nada
  const next =
